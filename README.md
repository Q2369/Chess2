...
8. Пешка берёт по вертикали только при столкновении по правилу 3
   ...
   <img src="images/rulesImages/rule78.png" alt="Пример к правилам 7 и 8" width="400">
...
14. Король не может вставать на клетку, которую может занять вражеская пешка, если занимаемая клетка не соответствует цвету короля
   ...
   <img src="images/rulesImages/rule14.png" alt="Пример к правилу 14" width="400">
...
|---------------------------|-------------------------|
| ![Планшет горизонтально](images/screenshots/tabletScreenHorizontal.png) | ![Планшет вертикально](images/screenshots/tabletScreenVertival.png) |
...
- GitHub: [@Q2369](https://github.com/Q2369)

## 🔮 Развитие проекта

Проект находится в активной разработке. Развитие осуществляется автором самостоятельно.
...
[⬆️ Вернуться к началу](#chess2--синхронные-шахматы)
